...
type ComplexityRoot struct {
	...
	Query struct {
		DailyDataSets func(childComplexity int, begin *time.Time, end *time.Time) int
...
type QueryResolver interface {
	DailyDataSets(ctx context.Context, begin *time.Time, end *time.Time) ([]*model.DailyData, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.dailyDataSets":
		...
		return e.complexity.Query.DailyDataSets(childComplexity, args["begin"].(*time.Time), args["end"].(*time.Time)), true
...
type Query {
    dailyDataSets(begin: Time="2010-01-01T00:00:00Z" end: Time="9999-12-31T00:00:00Z"): [DailyData!]!
...
func (ec *executionContext) _Query_dailyDataSets(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().DailyDataSets(rctx, args["begin"].(*time.Time), args["end"].(*time.Time))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
